...
const actions = [getBalanceAction, transferAction];

// Initial banner with chalk styling
console.log(`\n${chalk.cyan("┌────────────────────────────────────────┐")}`);
console.log(
  chalk.cyan("│") +
    chalk.yellow.bold("            CARDANO PLUGIN             ") +
    chalk.cyan(" │")
);
console.log(chalk.cyan("├────────────────────────────────────────┤"));
console.log(
  chalk.cyan("│") +
    chalk.white("  Initializing CARDANO Services...      ") +
    chalk.cyan("│")
);
console.log(
  chalk.cyan("│") +
...
const cardanoSeedPhrase = config.CARDANO_SEED_PHRASE
  ? chalk.green("✓")
  : chalk.red("✗");
const cardanoBlockfrostIdMainnet = config.CARDANO_BLOCKFROST_ID_MAINNET
  ? chalk.green("✓")
  : chalk.red("✗");
const cardanoBlockfrostIdPreprod = config.CARDANO_BLOCKFROST_ID_PREPROD
  ? chalk.green("✓")
  : chalk.red("✗");
...
console.log(
  chalk.cyan("│") +
    chalk.white(` CARDANO Seed Phrase               : ${cardanoSeedPhrase}  `) +
    chalk.cyan("│")
);
console.log(
  chalk.cyan("│") +
    chalk.white(
      ` CARDANO Blockfrost ID Mainnet     : ${cardanoBlockfrostIdMainnet}  `
    ) +
    chalk.cyan("│")
);
console.log(
  chalk.cyan("│") +
    chalk.white(
      ` CARDANO Blockfrost ID Preprod     : ${cardanoBlockfrostIdPreprod}  `
    ) +
    chalk.cyan("│")
);
console.log(chalk.cyan("└────────────────────────────────────────┘"));
...
const cardanoPlugin: Plugin = {
  ...
  description:
    "Cardano integration plugin supporting transfers, swaps, staking, bridging, and token deployments",
  services: [],
  actions: actions,
  tests: [],
};
